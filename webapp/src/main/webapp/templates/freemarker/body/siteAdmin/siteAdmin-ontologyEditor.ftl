...
<#if ontologyEditor?has_content>
    <section class="pageBodyGroup" role="region">
        ...
        <ul role="navigation">
        	<li role="listitem"><a href="./classpage">Class editor</a></li>
        	<li role="listitem"><a href="./propertypage">Object property editor</a></li>
        	<li role="listitem"><a href="./datapropertypage">Data property editor</a></li>
        </ul>
